      ...
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="mt-8">
            ...
            <h1 className="mt-4 text-5xl font-bold text-foreground sm:text-6xl">{category.name}</h1>
        ...
        {category.subcategories && category.subcategories.length > 0 && (
          <div className="mt-16">
            <h2 className="mb-8 text-3xl font-bold text-foreground">Subcategories</h2>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {category.subcategories.map((subcat) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-semibold text-foreground">{subcat.name}</h3>
        ...
        {category.subcategories && (
          <div className="mt-20 border-t border-border pt-12">
            <h2 className="mb-8 text-3xl font-bold text-foreground">Popular Items</h2>
